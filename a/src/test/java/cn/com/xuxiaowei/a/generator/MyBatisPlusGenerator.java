package cn.com.xuxiaowei.a.generator;
...
class MyBatisPlusGenerator {
     ...
     * 主包名
     */
    private static String parent = "cn.com.xuxiaowei.a";
    ...
    enum Datasource {
        ...
        /**
         * MySQL 数据库 seata-demo-a
         */
        MYSQL_A("jdbc:p6spy:mysql://127.0.0.1:3306/seata-demo-a?useSSL=false&serverTimezone=GMT%2B8&characterEncoding=UTF-8",
                "root", "root", "MySQL 数据库 seata-demo-a"),
