 ...
 *
 * @author L.cm
 * @see <a href="https://github.com/baomidou/generator/blob/develop/mybatis-plus-generator/src/main/java/com/baomidou/mybatisplus/generator/FastAutoGenerator.java">FastAutoGenerator</a>
 * @since 2021-07-22
 */
public final class FastAutoGenerator {
    ...
    public static FastAutoGenerator create(DataSource dataSource) {
